...
import { getCompanyLogo, getBenefitIcon } from "@/lib/icon-utils";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
            ...
            <div className="flex gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-50 border border-slate-200 shadow-sm shrink-0">
                {getCompanyLogo(job.companyName, "h-8 w-8 text-slate-600")}
              </div>
          ...
          <div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-xs text-slate-500 border-t border-slate-100 mt-8 pt-5">
            <span className="flex items-center gap-1.5 font-medium">
              ...
              Experience:{" "}
              <strong className="text-slate-800">{job.experience}</strong>
            </span>
            <span className="flex items-center gap-1.5 font-medium">
            ...
            <span className="flex items-center gap-1.5 font-medium ml-auto">
              ...
              Posted:{" "}
              <strong className="text-slate-800">{job.postedTime}</strong>
            </span>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <div className="bg-white border border-border rounded-3xl p-6 md:p-8 space-y-5 shadow-sm">
              ...
              <div className="bg-white border border-border rounded-3xl p-6 md:p-8 space-y-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  ...
                  <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-100">
                    ...
                    <span className="text-sm font-bold text-slate-900 block mt-1.5 line-clamp-1">
                      {company.employees.split(" ")[0]}
                    </span>
                  </div>
                  <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-100">
                    <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(company.workLifeBalance / 5) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-brand-primary rounded-full"
                          style={{
                            width: `${(company.jobSecurity / 5) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-brand-primary rounded-full"
                          style={{
                            width: `${(company.salaryBenefits / 5) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-brand-primary rounded-full"
                          style={{
                            width: `${(company.careerGrowth / 5) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                {job.benefits.map((ben, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 border border-slate-100 shadow-xs shrink-0">
                      {getBenefitIcon(
                        ben.icon,
                        ben.title,
            ...
            <div className="bg-amber-50/50 border border-amber-100 rounded-3xl p-6 space-y-3">
              ...
              <p className="text-[11px] text-amber-900/80 leading-relaxed">
                Do not pay any verification fees or buying deposits to potential
                employers. JobPortal never handles payment transfers on behalf
                of hiring entities. Report any suspicious behavior.
              </p>
              <a
                href="#"
                className="inline-block text-[10px] font-bold text-brand-primary hover:underline"
              >
