import { LayoutGrid, Briefcase, Users, Calendar, UserCheck, Megaphone, BarChart2, Building2, CreditCard, Bell, CheckSquare, Settings } from "lucide-react";
import { NavItemConfig } from "@/components/layout/Sidebar";

export function getRecruiterNavItems(activePath: string, tasksCount = 3): NavItemConfig[] {
  return [
